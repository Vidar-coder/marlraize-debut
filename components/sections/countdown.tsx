...
const outsideDividerLineStyle = {
  background: "linear-gradient(to right, transparent, rgb(253 236 230 / 70%), transparent)",
} as const

const outsideDividerLineStyleLeft = {
  background: "linear-gradient(to left, transparent, rgb(253 236 230 / 70%), transparent)",
} as const
...
function OutsideDivider() {
  return (
    <div className="flex items-center justify-center gap-1.5">
      ...
      <span className="h-0.5 w-0.5 rounded-full bg-[#FDECE6]/70 sm:h-1 sm:w-1" aria-hidden />
      <span className="h-px w-6 sm:w-10" style={outsideDividerLineStyleLeft} />
    </div>
  )
}
    ...
    >
      <span
        ...
        style={{
          ...
          color: WHITE,
          textShadow: "0 2px 18px rgb(151 108 88 / 45%)",
        }}
      >
        Counting Down
      </span>
      <span
        ...
        style={{
          ...
          color: WHITE,
          textShadow: "0 2px 16px rgb(151 108 88 / 40%), 0 0 22px rgb(230 163 155 / 35%)",
        }}
      >
        To her debut
      </span>
    ...
    <div className="flex flex-col items-center gap-1.5 sm:gap-2">
      <div className="relative w-full max-w-[88px] sm:max-w-[96px] md:max-w-[110px] lg:max-w-[120px]">
        <div
          ...
          style={{
            background: "rgb(253 236 230 / 14%)",
            borderColor: "rgb(253 236 230 / 42%)",
            boxShadow: "0 8px 22px rgb(151 108 88 / 18%), inset 0 1px 0 rgb(253 236 230 / 35%)",
          ...
          <div className="relative z-10 flex items-center justify-center">
            <Counter
              ...
              digitStyle={{
                ...
                color: WHITE,
                textShadow: "0 1px 10px rgb(151 108 88 / 45%)",
              }}
            />
          </div>
        </div>
      ...
      <span
        ...
        style={{ color: WHITE, textShadow: "0 1px 8px rgb(151 108 88 / 40%)" }}
      >
        {label}
      </span>
    </div>
...
export function Countdown() {
  ...
  const { debutNickname, debut } = siteConfig.couple
    ...
    >
      ...
      <div className="relative z-10 mb-6 px-3 text-center sm:mb-8 sm:px-4 md:mb-10">
        ...
        <div className="mt-3 flex items-center justify-center sm:mt-4">
          <span className="h-px w-16 sm:w-24 md:w-32 bg-[#FDECE6]/55" />
        </div>
      </div>
            ...
            <div className="relative sm:rounded-3xl p-6 sm:p-8 md:p-10 mb-6 sm:mb-8">
              <div className="w-full max-w-2xl mx-auto">
                <div
                  ...
                  style={{ color: WHITE, textShadow: "0 2px 16px rgb(151 108 88 / 40%)" }}
                >
                  {/* Month */}
                  ...
                  <div className="flex w-full items-center gap-2 sm:gap-4 md:gap-5">
                    ...
                    <div className="flex flex-1 items-center justify-end gap-1.5 sm:gap-2.5">
                      <span className="h-[0.5px] flex-1 bg-[#FDECE6]/55" />
                      <span className="text-[0.6rem] uppercase tracking-[0.3em] sm:text-[0.7rem] sm:tracking-[0.4em] md:text-xs">
                        {ceremonyDayShort}
                      </span>
                      <span className="h-[0.5px] w-6 bg-[#FDECE6]/55 sm:w-8 md:w-10" />
                    </div>
