...
const HERO_ACCENT = '#E6A39B';
const MENU_PANEL_BG = '#FDECE6';
const MENU_TEXT = '#976C58';
...
.sm-scope .sm-toggle, .sm-toggle-host .sm-toggle { position: relative; display: inline-flex; align-items: center; justify-content: center; width: 2.5rem; height: 2.5rem; background: transparent; border: none; cursor: pointer; color: #FDECE6; font-weight: 500; line-height: 1; overflow: visible; }
...
.sm-scope .sm-toggle:focus-visible { outline: 2px solid #E6A39B; outline-offset: 4px; border-radius: 4px; }
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: #FDECE6; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6.5em 2.25em 2.25em 2.25em; overflow-y: auto; z-index: 10; }
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1.05rem; font-weight: 500; color: var(--sm-accent, #E6A39B); }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, #E6A39B); outline-offset: 3px; }
.sm-scope .sm-socials-link { font-size: 1rem; font-weight: 500; color: #976C58; text-decoration: none; position: relative; padding: 2px 0; display: inline-block; transition: color 0.3s ease, opacity 0.3s ease; }
...
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, #E6A39B); }
.sm-scope .sm-panel-title { margin: 0; font-size: 1rem; font-weight: 600; color: #976C58; text-transform: uppercase; }
.sm-scope .sm-panel-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 0.4rem; }
.sm-scope .sm-panel-item { position: relative; color: #976C58; font-weight: 600; font-size: 1.55rem; cursor: pointer; line-height: 1.15; letter-spacing: -0.6px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
...
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #E6A39B); }
